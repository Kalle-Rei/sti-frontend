...
function createTable(data) {
    ...
    aTable.appendChild(createRow(data[0].name, data[0].location, data[0].logo));
    aTable.appendChild(createRow(data[1].name, data[1].location, data[1].logo));
    aTable.appendChild(createRow(data[2].name, data[2].location, data[2].logo));
    aTable.appendChild(createRow(data[3].name, data[3].location, data[3].logo));
}
// function createTable(data) {
//   let appElement = document.getElementById("app");
//   let aTable = document.createElement("table");
